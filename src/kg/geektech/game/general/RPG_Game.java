...
public class RPG_Game {
    ...
    public static void startGame() {
        Boss boss = new Boss(10000, 50, "Helkart");

        Warrior warrior = new Warrior(270, 10, "Artur");
        Medic doc = new Medic(250, 5, 15, "Aibolit");
        Magic magic = new Magic(260, 20, 20,"Merlin");
        Berserk berserk = new Berserk(280, 15, "Ragnar");
        Medic assistant = new Medic(290, 10, 5, "Malysh");
        Golem golem = new Golem(5000,5,"Golem",5);
        Thor thor = new Thor(290,30,"Thor");
        Wither wither = new Wither(400,0,"Wither");
        Hero[] heroes = {warrior, doc, magic, berserk, assistant, golem, thor, wither};
